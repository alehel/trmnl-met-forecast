...
- **Hour-by-hour Timeline** (full layout): Hourly forecast for the next 24 hours, 2-hour aggregated rows (precipitation summed, temperature averaged) for the rest of tomorrow, then 6-hour blocks with max/min temperatures for the following days — with day headers and dates at each day change
