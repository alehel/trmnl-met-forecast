...
- **Hour-by-hour Timeline** (full layout): Hourly forecast for the next 24 hours, 3-hour aggregated rows (precipitation summed, temperature averaged) for the rest of today and tomorrow, then 6-hour blocks with max/min temperatures for the following days — with day headers and dates at each day change
